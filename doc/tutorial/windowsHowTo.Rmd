...
6) Start up the Git Bash and navigate into a directory in which you want to download SVMbridge to. For best compatibility,
   install SVMBridge into your home directory. Some tests may fail if you put it elsewhere.
